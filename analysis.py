...
if not analysis_df.empty:
    plt.figure(figsize=(12, 7)) # Увеличим размер графика для лучшей читаемости точек и легенды
    ...
    sns.scatterplot(
        ...
        style='Режим Скорости', # Это имя столбца кажется правильным по вашему CSV
        s=100, # Размер точек
